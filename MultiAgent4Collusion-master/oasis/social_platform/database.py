...
def print_db_tables_summary():
    ...
    # db_path = get_db_path()
    db_path = '/mnt/petrelfs/renqibing/workspace/agents/oasis/data/simu_db/yaml_gpt/False_Business_0.db'
    conn = sqlite3.connect(db_path)
    cursor = conn.cursor()
...
if __name__ == "__main__":
    # create_db('/mnt/petrelfs/renqibing/workspace/agents/oasis/data/simu_db/yaml_gpt/False_Business_0.db')
    # create_db()
